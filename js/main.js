...
(function headerParallax(){
  ...
  // 👉 Desactiva el “pin/parallax” en pantallas chicas
...
(function setupProjectGallery(){
  ...
  const GALLERY = {
    ...
    "dmnt-toy": [
      ...
      "../img/DMNTTOY/644f0867-8c1c-4d76-8e38-651615231c60.jpg",
      "../img/DMNTTOY/0f81e49d-d939-4aae-91c0-d3e59fcaf2ea.jpg",
      "../img/DMNTTOY/da6dbc5e-ee05-458a-9226-af009db68aec.jpg",
      "../img/DMNTTOY/e162b2d7-fdc1-4e29-9bae-5dcc1af4daef.jpg"
    ],
    "dmnt-render": [
      "../img/dmntrender/DMNTTOYLANZAMIENTORVSV.mp4",
      "../img/dmntrender/DMNTTOYLANZAMIENTOSHAZAM.mp4",
      "../img/dmntrender/renderportada.png",
      "../img/dmntrender/renderportada1.png",
      "../img/dmntrender/renderportada2.png",
      "../img/dmntrender/renderportada3.png",
      "../img/dmntrender/renderportada4.png",
      "../img/dmntrender/renderportada5.png",
    ],
    "stopmotion": [
      "../img/stopmotion/Labrecha.mp4",
      "../img/stopmotion/escena3(420).png",
      "../img/stopmotion/escena3(293).png"
    ],
    "motiongraphics": [
      "../img/motiongraphics/logodmntrender.mp4",
      "../img/motiongraphics/azurcomercial.mp4",
      "../img/motiongraphics/azurcomercial2.mp4"
    ],
  };
